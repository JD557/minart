// Copied from
// https://github.com/regb/scalanative-graphics-bindings/blob/d8b3e8ee13e10fe0aaf972fdac3f7d9f5a42ee07/sdl2/src/main/scala/sdl2/Extras.scala
...
object Extras {
  ...
  def SDL_ISPIXELFORMAT_ALPHA(format: UInt): Boolean =
    !SDL_ISPIXELFORMAT_FOURCC(format) && ((SDL_PIXELORDER(format) == SDL_PACKEDORDER_ARGB) ||
  ...
  val SDL_WINDOW_FULLSCREEN_DESKTOP = SDL_WINDOW_FULLSCREEN | 0x00001000.toUInt
